...
Public Class rptTransWithQuota
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartScale.rptTransWithQuota.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DateQuota() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptTransWithQuota
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransWithQuota = New rptTransWithQuota
        rpt.Site = Me.Site
        Return rpt
    End Function
