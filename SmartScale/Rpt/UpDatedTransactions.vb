...
Public Class UpDatedTransactions
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "UpDatedTransactions.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartScale.UpDatedTransactions.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUpDatedTransactions
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As UpDatedTransactions = New UpDatedTransactions
        rpt.Site = Me.Site
        Return rpt
    End Function
