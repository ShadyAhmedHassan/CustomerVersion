...
Public Class cfrmChoose
    ...
    Private Sub cfrmChoose_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If gAdo.CmdExecScalar("select Allow from tblUserPermission where Permission_ID=14 and User_ID= " & gUserID) = True Then
        ...
        End If
        If gAdo.CmdExecScalar("select Allow from tblUserPermission where Permission_ID=15 and User_ID= " & gUserID) = True Then
